# Generated by Django 5.1.6 on 2025-02-05 16:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('available', 'available'), ('available', 'rental'), ('sold', 'sold')], max_length=50, null=True)),
